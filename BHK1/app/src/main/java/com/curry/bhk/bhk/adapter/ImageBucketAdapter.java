...
public class ImageBucketAdapter extends BaseAdapter
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		{
			String thumbPath = item.mImageList.get(0).thumbnailPath;
			String sourcePath = item.mImageList.get(0).sourcePath;
		...
		mHolder.titleTv.setText(item.mBucketName);
		mHolder.countTv.setText(item.mCount + "picture");
